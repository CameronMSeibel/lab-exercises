...
water.pkm.by.t.2 <- group_by(water.pkm, Type.2)
# View your new variable -- did it affect anything?
View(water.pkm.by.t.2)
# It changes nothing externally.
...
# within each group.
summarize(water.pkm.by.t.2, mean(Speed), max(HP))
